...
@Component({
  ...
  templateUrl: './irttest.component.html',
  styleUrls: ['./irttest.component.scss']
})
export class IrttestComponent implements OnInit {
  ...
  addIRTResult() {
    const candidate = {
      ...
      psy_score:this.points,
      irt_test_status:"completed",
    };
    ...
    mySessionData.irt_test_status = 'completed'
